...
var _stickyNav = require("./stickyNav");
var _menu = require("./menu");
var _modal = require("./modal");
(0, _stickyNav.enableStickyNavigation)();
(0, _menu.enableMobileMenu)();
(0, _modal.activateModal)();
function initMap() {
...
function evbFix() {
    window.addEventListener("load", (event)=>{
        waitForElementById("eventbrite-widget-modal-overlay", function() {
            observeCssProperty(document.getElementById("eventbrite-widget-modal-overlay"), "style", function(value) {
                if (value === 0) document.body.removeAttribute("style");
            });
        });
    });
}
...
},{"../css/main.css":"7E1TK","./stickyNav":"5VsC6","./menu":"j6KIH","./modal":"cmqWk"}],"7E1TK":[function() {},{}],"5VsC6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "enableStickyNavigation", ()=>enableStickyNavigation);
const enableStickyNavigation = ()=>{
...
},{}],"j6KIH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "enableMobileMenu", ()=>enableMobileMenu);
const enableMobileMenu = ()=>{
    ...
    navLinks.forEach((link)=>{
        link.addEventListener("click", (e)=>{
            ...
            if (!isDesktop && navList.classList.contains("animate-hidden")) return e.preventDefault();
            const nav = new URL(link.href);
            const loc = new URL(location.href);
            if (nav.origin !== loc.origin) return;
            if (nav.origin === loc.origin && nav.pathname !== loc.pathname) return;
            if (link.hash) {
                e.preventDefault();
...
const openModal = (e)=>{
    const { target  } = e;
    const modal = target.tagName === "BUTTON" ? target.parentElement.querySelector('[role="dialog"]') : target.parentElement.parentElement.querySelector('[role="dialog"]');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l5fJw","iycwR"], "iycwR", "parcelRequire1c30")
